        ...
        >
          ...
          >
            ...
            <div className={styles.carouselRow}>
              <button className={styles.arrowBtn} onClick={goPrev} aria-label="Previous experience">
                <RiArrowLeftSLine />
              </button>
              ...
              <button className={styles.arrowBtn} onClick={goNext} aria-label="Next experience">
                <RiArrowRightSLine />
              </button>
            </div>
